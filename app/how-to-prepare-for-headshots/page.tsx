            ...
            <div className="max-w-4xl mx-auto">
              <SectionReveal>
                ...
                <div className="space-y-4 text-lg text-[var(--color-text-body)] leading-relaxed">
                  ...
                  <p>
                    When you arrive, we&apos;ll do a brief consultation to review your goals and outfits. Sessions can run up to 3 hours, though we can move faster if you need to get in and out quickly. Unlimited wardrobe changes are included. Your professionally edited images are delivered to a private online gallery within 48 hours.
                  </p>
                </div>
